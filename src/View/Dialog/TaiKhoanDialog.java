        ...
        btnCapNhat.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!(username.getText().length() == 0)) {
                    ...
                    taiKhoan.loadTable(taiKhoan.taiKhoanBus.getTaiKhoanAll());
                       JOptionPane.showMessageDialog(null, "Cập nhật tài khoản thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                    dispose();
                } else {
...
//                password.setEditable(false);
    ...
    public boolean validateInput() {
        if (username.getText().length() == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng nhập mật khẩu mạnh hơn");
            return false;
        }
        return true;
    }
