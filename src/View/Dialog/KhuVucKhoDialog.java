...
public final class KhuVucKhoDialog extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnThem && Validation()) {
            ...
            boolean added = jpkvk.kvkBUS.add(new KhuVucKhoDTO(makhuvuc, tenkhuvuc, ghichu));
            if (added) {
                jpkvk.loadDataTable(jpkvk.listKVK);
                JOptionPane.showMessageDialog(this, "Tạo khu vực thành công!", "Thêm khu vực kho!", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            }
            // Nếu không thành công, đã có thông báo trong BUS rồi (ví dụ "Tên khu vực đã tồn tại")
            ...
            jpkvk.loadDataTable(jpkvk.listKVK);
            dispose();
            JOptionPane.showMessageDialog(this, "Cập nhật khu vực thành công!", "Cập nhật khu vực kho!", JOptionPane.INFORMATION_MESSAGE);
        }
    }
