...
import Model.DTO.NhaCungCapDTO;
...
public class NhaCungCapDialog extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnThem && Validation()) {
            ...
            boolean added = jpNcc.nccBUS.add(new NhaCungCapDTO(mancc, tenNcc.getText(), diachi.getText(), email.getText(), sodienthoai.getText()));
            ...
            if (added) {
                ...
                // Nếu bạn có logic kiểm tra trùng tên trong BUS, có thể show thêm lỗi ở đây
                JOptionPane.showMessageDialog(this, "Không thể thêm nhà cung cấp! Có thể do lỗi trùng hoặc dữ liệu không hợp lệ.", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }

        } else if (e.getSource() == btnHuyBo) {
            dispose();
        } else if (e.getSource() == btnCapNhat && Validation()) {
             boolean updated  =  jpNcc.nccBUS.update(new NhaCungCapDTO(nccDTO.getMancc(), tenNcc.getText(), diachi.getText(), email.getText(), sodienthoai.getText()));
            if (updated) {
                jpNcc.loadDataTable(jpNcc.listncc);
                JOptionPane.showMessageDialog(this, "Cập nhật nhà cung cấp thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Không thể cập nhật nhà cung cấp! Có thể do lỗi hệ thống hoặc dữ liệu không hợp lệ.", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}
